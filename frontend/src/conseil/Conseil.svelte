...
<div class="advisor-layout">
  ...
  <div class="advisor-content">
    ...
    <div class="card" id="adv-usage">
      ...
      <div id="advisor-usage-summary" class="text-muted" style="font-size:13px">
        {#if usage}
          ...
          {#if budget != null && budget > 0 && part != null}
            ...
            {#if part >= 80 && part < 100}
              <div class="advisor-budget-warning" style="margin-top:.5rem;padding:.4rem .6rem;border-left:3px solid var(--warning);background:rgba(234,179,8,.1);font-size:12px;border-radius:4px">
            ...
            {:else if part >= 100}
              <div class="advisor-budget-warning" style="margin-top:.5rem;padding:.4rem .6rem;border-left:3px solid var(--danger);background:rgba(239,68,68,.1);font-size:12px;border-radius:4px">
