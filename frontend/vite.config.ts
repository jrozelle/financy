  ...
  build: {
    ...
    lib: {
      entry: { credits: 'src/credits/main.ts', positions: 'src/positions/main.svelte.ts',
               ...
               actifs: 'src/actifs/main.svelte.ts',
               performance: 'src/performance/main.svelte.ts',
               conseil: 'src/conseil/main.svelte.ts',
               outils: 'src/outils/main.svelte.ts',
               referentiel: 'src/referentiel/main.svelte.ts',
               import: 'src/import/main.svelte.ts' },
      formats: ['es'],
